...
<div class="wrap curai-wrap">
	<h1><?php esc_html_e( 'Curator AI — Automation Rules', 'curator-ai' ); ?></h1>
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<div class="curai-card">
			<h2><?php esc_html_e( 'On Post Save', 'curator-ai' ); ?></h2>

			<h3><?php esc_html_e( 'Generate Meta Title', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Run when a post is saved', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Post types', 'curator-ai' ); ?></th>
					<td>
						<input type="text" class="regular-text"
							...
							placeholder="<?php esc_attr_e( 'post, page', 'curator-ai' ); ?>">
						<p class="description"><?php esc_html_e( 'Comma-separated post type slugs. Leave blank for all.', 'curator-ai' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Skip if exists', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Skip if a meta title already exists', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
			</table>

			<h3><?php esc_html_e( 'Generate Meta Description', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
				...
				<tr>
					...
					<td>
						<label>
							...
							<?php esc_html_e( 'Skip if a meta description already exists', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
			</table>

			<h3><?php esc_html_e( 'Check Readability', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
		...
		<div class="curai-card">
			<h2><?php esc_html_e( 'On Media Upload', 'curator-ai' ); ?></h2>

			<h3><?php esc_html_e( 'Generate Alt Text', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Run when media is uploaded', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					...
					<td>
						<label>
							...
							<?php esc_html_e( 'Skip if alt text already exists', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Max file size (MB)', 'curator-ai' ); ?></th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Skip images larger than this size. 0 = no limit.', 'curator-ai' ); ?></p>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="curai-card">
			<h2><?php esc_html_e( 'Scheduled', 'curator-ai' ); ?></h2>

			<h3><?php esc_html_e( 'Weekly Audit', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Run a full audit weekly', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Day of week', 'curator-ai' ); ?></th>
					<td>
				...
				<tr>
					<th scope="row"><?php esc_html_e( 'Report email', 'curator-ai' ); ?></th>
					<td>
			...
			<h3><?php esc_html_e( 'Stale Content Check', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Flag posts that have not been updated recently', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Interval (months)', 'curator-ai' ); ?></th>
					<td>
				...
				<tr>
					<th scope="row"><?php esc_html_e( 'Notify', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Send an email when stale content is found', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
			</table>

			<h3><?php esc_html_e( 'Broken Link Scan', 'curator-ai' ); ?></h3>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row"><?php esc_html_e( 'Enabled', 'curator-ai' ); ?></th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Periodically scan for broken links', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th scope="row"><?php esc_html_e( 'Interval (days)', 'curator-ai' ); ?></th>
					<td>
						<input type="number" min="1" step="1"
		...
		<p class="submit">
			<button type="submit" class="button button-primary"><?php esc_html_e( 'Save automation rules', 'curator-ai' ); ?></button>
		</p>
	</form>
</div>
