...
$curai_bulk_abilities = array(
	array(
		...
		'slug'        => 'audit-stale',
		'label'       => __( 'Stale Content Audit', 'curator-ai-seo-site-care' ),
		'description' => __( 'Flags posts and pages that have not been updated within the configured threshold. Helps identify content that may need a refresh.', 'curator-ai-seo-site-care' ),
	),
	array(
		'id'          => 'curator-ai/audit-readability',
		'slug'        => 'audit-readability',
		'label'       => __( 'Readability Audit', 'curator-ai-seo-site-care' ),
		'description' => __( 'Checks Flesch–Kincaid readability scores across published posts and pages. Surfaces content that may be too complex for your target audience.', 'curator-ai-seo-site-care' ),
	),
	array(
		'id'          => 'curator-ai/audit-missing-meta-alt',
		'slug'        => 'audit-missing-meta-alt',
		'label'       => __( 'Missing Meta & Alt Text Audit', 'curator-ai-seo-site-care' ),
		'description' => __( 'Scans for posts missing SEO meta titles or descriptions, and images missing alt text. Essential for basic on-page SEO.', 'curator-ai-seo-site-care' ),
	),
	array(
		'id'          => 'curator-ai/audit-thin-content',
		'slug'        => 'audit-thin-content',
		'label'       => __( 'Thin Content Audit', 'curator-ai-seo-site-care' ),
		'description' => __( 'Identifies posts with low word counts that may be considered thin by search engines and hurt rankings.', 'curator-ai-seo-site-care' ),
	),
	array(
		'id'          => 'curator-ai/audit-broken-links',
		'slug'        => 'audit-broken-links',
		'label'       => __( 'Broken Link Scan', 'curator-ai-seo-site-care' ),
		'description' => __( 'Crawls internal and external links in post content to find 4xx/5xx responses. Broken links harm user experience and crawlability.', 'curator-ai-seo-site-care' ),
	),
	array(
		'id'          => 'curator-ai/audit-perf',
		'slug'        => 'audit-perf',
		'label'       => __( 'Performance Audit', 'curator-ai-seo-site-care' ),
		'description' => __( 'Checks page weight, image sizes, and other front-end performance signals across the site. Surfaces pages that may score poorly in Core Web Vitals.', 'curator-ai-seo-site-care' ),
	),
);
?>
<div class="wrap curai-wrap">
	<h1><?php esc_html_e( 'Curator AI — Bulk Operations', 'curator-ai-seo-site-care' ); ?></h1>
		...
		<?php foreach ( $curai_bulk_abilities as $curai_ability ) : ?>
			<div class="curai-card">
				...
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
					...
					<button type="submit" class="button button-primary"><?php esc_html_e( 'Run now', 'curator-ai-seo-site-care' ); ?></button>
				</form>
				<?php if ( ( 'bulk_ran_' . $curai_ability['slug'] ) === $curai_notice_code ) : ?>
					<p class="curai-status-ok" style="margin-top:0.5em;">
						<?php esc_html_e( 'Completed successfully.', 'curator-ai-seo-site-care' ); ?>
					</p>
				<?php elseif ( ( 'bulk_error_' . $curai_ability['slug'] ) === $curai_notice_code ) : ?>
					<p class="curai-status-bad" style="margin-top:0.5em;">
						<?php esc_html_e( 'Error during last run.', 'curator-ai-seo-site-care' ); ?>
					</p>
				<?php endif; ?>
			</div>
		<?php endforeach; ?>
