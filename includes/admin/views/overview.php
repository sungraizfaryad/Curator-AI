    ...
    <div class="curai-card">
        ...
        <ul>
            <li>
                ...
                <?php echo $ai_status['available'] ? esc_html__( 'Yes', 'curator-ai' ) : esc_html__( 'No', 'curator-ai' ); ?>
            </li>
            <li>
                <strong><?php esc_html_e( 'AI plugin active:', 'curator-ai' ); ?></strong>
                <?php echo $ai_status['plugin_active'] ? esc_html__( 'Yes', 'curator-ai' ) : esc_html__( 'No', 'curator-ai' ); ?>
            </li>
            <li>
                <strong><?php esc_html_e( 'Provider configured:', 'curator-ai' ); ?></strong>
                <?php echo $ai_status['provider_configured'] ? esc_html__( 'Yes', 'curator-ai' ) : esc_html__( 'No', 'curator-ai' ); ?>
            </li>
        </ul>
    </div>
