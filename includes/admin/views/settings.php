...
<div class="wrap curai-wrap">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<div class="curai-card">
			<h2><?php esc_html_e( 'General', 'curator-ai' ); ?></h2>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row">
						<label for="curai_model_default"><?php esc_html_e( 'Default model', 'curator-ai' ); ?></label>
					</th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'AI model identifier passed to the WordPress AI Client. Leave blank to use the provider default.', 'curator-ai' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="curai_budget_cap_enabled"><?php esc_html_e( 'Monthly budget cap', 'curator-ai' ); ?></label>
					</th>
					<td>
						<label>
							...
							<?php esc_html_e( 'Enable monthly budget cap', 'curator-ai' ); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="curai_budget_cap_usd"><?php esc_html_e( 'Budget cap (USD)', 'curator-ai' ); ?></label>
					</th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Stop AI generation when monthly spend exceeds this amount.', 'curator-ai' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<label for="curai_pagespeed_api_key"><?php esc_html_e( 'PageSpeed API key', 'curator-ai' ); ?></label>
					</th>
					<td>
						...
						<p class="description"><?php esc_html_e( 'Google PageSpeed Insights API key for performance audits.', 'curator-ai' ); ?></p>
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="curai-card">
			<h2><?php esc_html_e( 'SEO Adapter', 'curator-ai' ); ?></h2>
			<table class="form-table" role="presentation">
				<tr>
					<th scope="row">
						<label for="curai_seo_adapter_override"><?php esc_html_e( 'Adapter override', 'curator-ai' ); ?></label>
					</th>
					<td>
						<select id="curai_seo_adapter_override" name="curai_seo_adapter_override">
							<option value="auto" <?php selected( $curai_override, 'auto' ); ?>><?php esc_html_e( 'Auto-detect', 'curator-ai' ); ?></option>
							<option value="yoast" <?php selected( $curai_override, 'yoast' ); ?>><?php esc_html_e( 'Yoast SEO', 'curator-ai' ); ?></option>
							<option value="rank-math" <?php selected( $curai_override, 'rank-math' ); ?>><?php esc_html_e( 'Rank Math', 'curator-ai' ); ?></option>
							<option value="native" <?php selected( $curai_override, 'native' ); ?>><?php esc_html_e( 'Native (WordPress core)', 'curator-ai' ); ?></option>
						</select>
						<p class="description">
							<?php
							echo esc_html(
								sprintf(
									...
									__( 'Currently active: %s', 'curator-ai' ),
									$curai_adapter_label
								)
							);
							?>
		...
		<p class="submit">
			<button type="submit" class="button button-primary"><?php esc_html_e( 'Save settings', 'curator-ai' ); ?></button>
		</p>
	</form>
</div>
